...
namespace Races
{
    public class MainScriptRaces : Script
    {
        ...
        public void OnTick(object sender, EventArgs e)
        {
            ...
            if (!_isInRace)
            {
                ...
                foreach (var race in _races)
                {
                    ...
                    Function.Call(Hash._ADD_TEXT_COMPONENT_STRING, "Press ~INPUT_CONTEXT~ to participate in this Race.");
                ...
                if (Game.Player.Character.IsInVehicle() && Game.Player.Character.IsInRangeOf(_checkpoints[0], 10f))
                {
                    ...
                    if (_checkpoints.Count == 0)
                    {
                        ...
                        _passed.OnContinueHit += () =>
                        {
                            ...
                            // commented that don't leave care
                            //Game.Player.Character.Position = _currentRace.Trigger;
        ...
        public void BuildMenu(Race race)
        {
            ...
            //_previewVehicle.IsPersistent = true;//default false
        ...
        private void StartRace(Race race)
        {
            ...
            var car = Game.Player.Character.LastVehicle;//_previewVehicle;
            ...
            //car.IsPersistent = true; // default false
